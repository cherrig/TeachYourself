...
public class ScoreActivity extends BaseActivity {
    ...
    private void saveScore() {
        ...
        RequestBody categoryBody = Client.getBodyParam(category);

        userService.save(emailBody, categoryBody, score, questionNumber, avgResponseTime).enqueue(new Callback<String>() {
            @Override
